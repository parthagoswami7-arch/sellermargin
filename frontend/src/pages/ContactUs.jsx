      ...
      <main className="max-w-[900px] mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-border">
          ...
          <div className="p-6">
            ...
            <div className="text-sm">AHAN S INTERNATIONAL<br/>Kolkata, West Bengal, India</div>
          </div>
        </div>

        <div className="mt-12 pt-8 border-t border-border text-xs text-muted-foreground">
          <p>Business name: <b>AHAN S INTERNATIONAL</b> · GSTIN available on request via email. For grievance or escalation, mark your email subject with <span className="font-mono">GRIEVANCE</span> and we'll respond within 2 business days.</p>
        </div>
      </main>
